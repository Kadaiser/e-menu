...
public class UserOld {
	...
	private List<RestaurantOld> favoriteRestaurants;
	private List<Comment> comments;
	
	
	
	public static UserOld createUser(String login, String pass, String nickName,
									String mail, Date bornDate, String userFrom){
		...
		u.userFrom = userFrom;
		u.knownAllergens = new ArrayList<Allergen>();
		u.comments = new ArrayList<Comment>();
		u.favoriteRestaurants = new ArrayList<RestaurantOld>();
	...
	private static int processAge(Date bornDate) {
	...
	public void setKnownsAllergens(List<Allergen> knownAllergens) {
